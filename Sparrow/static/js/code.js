	...
	var ERROR_PHOTO_UPDDESC = "007002";				//图片描述为空
	var ERROR_PHOTO_UPLOAD = "007003";              //上传图片出错
	var ERROR_PHOTO_DELETE = "007004";              //删除图片出错

	var ERROR_COMMENT_EMPTY = "008000";				//comment empty
	var ERROR_COMMENT_STATUS = "008001";			//comment状态异常
	var ERROR_COMMENT_TYPE = "008002";				//comment类型异常
	...
	var ERROR_HAVE_FOLLOWED = "011002";					//follow failed

	
	var ERROR_AVATAR_CROP = "014000";
	var ERROR_AVATAR_CHANGE = "014001";

	var ERROR_Like = "015000";						//like failed
	var ERROR_LIKE_UNDO = "015001";					//unlike failed
	...
	var SUCCESS_PHOTO_DELETE = "107002";            // 删除照片成功
	
	var SUCCESS_COMMENT_CREATE = "108000";  		// 评论成功
	...
	var SUCCESS_FOLLOW = "111000";  				// 关注成功
	var SUCCESS_FOLLOW_UNDO = "111001"; 			//取消关注成功
	...
	var SUCCESS_SETTING_INFO_UPDATE = '115000';

	var SUCCESS_POST_LIKE = "116000";
	var SUCCESS_POST_UNLIKE = "116001";
	var SUCCESS_ALBUM_LIKE = "116002";
	var SUCCESS_ALBUM_UNLIKE = "116003";
