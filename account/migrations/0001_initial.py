    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_avatar', models.URLField(default='https://avatars3.githubusercontent.com/u/5500125?v=3&s=460')),
                ...
                ('signature', models.CharField(blank=True, default='', max_length=100, verbose_name='signature')),
            ...
            managers=[
                ('objects', account.managers.SparrowManager()),
            ],
        ),
    ]
